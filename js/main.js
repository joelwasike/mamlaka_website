(function ($) {
	...
	//     jQuery("#status").fadeOut(100);  // Fade out the status div faster (100ms)
	//     jQuery("#preloader").delay(150).fadeOut("fast");  // Reduce delay and speed up fade out
	// });
...
$(document).ready(function () {
	...
	$('#toggle, #toggle_close').on('click', toggleSidebar);
  });
